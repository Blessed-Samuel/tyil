  ...
  return (
    <section className="bg-primaryRed md:py-12 py-24 px-6">
      <div className="flex gap-18 md:flex-row flex-col justify-between items-center text-center">
        ...
        {/* divider-1 */}
        <div className="bg-gradient-to-r md:bg-gradient-to-t from-primaryRed via-primaryWhite mask-b-to-primaryRed md:h-[150px] md:w-[1.4px] w-[400px] h-[1.4px]"></div>

        <RollingCounter target={130} suffix="+" label="Post Secondary Youths" />

        {/* divider-2 */}
        <div className="bg-gradient-to-r md:bg-gradient-to-t from-primaryRed via-primaryWhite mask-b-to-primaryRed md:h-[150px] w-[400px] h-[1.4px] md:w-[1.4px]"></div>
