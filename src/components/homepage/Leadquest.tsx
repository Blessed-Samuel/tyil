                ...
                >
                  ...
                  >
                    <Image
                      ...
                      priority
                    />
                    <span className="absolute leading-5 inset-0 flex items-center justify-center text-sm sm:text-base font-medium text-white cursor-pointer hover:translate-x-4 transition-all duration-300">
                      SIGN UP FOR <br />
                      LEADQUEST 2025
